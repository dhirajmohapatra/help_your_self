				  ...
				  <div class="tab-content" id="registerTabContent">
					...
					<div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="signup-tab">
						...
						<form name="signup" enctype="multipart/form-data" class="form-validate" action="{{ URL::to('/signupProcess')}}" method="post">
							...
							<div class="row">
	                      	...
	                      	<div class="row">
	                      		<div class="col-md-6">
			                      	<div class="from-group mb-3">
										<label for="inlineFormInputGroup"><strong style="color: red;">*</strong>Sponsor</label>
										<div class="input-group">
											<input  name="sponsor" type="text" class="form-control field-validate field-validate" id="sponsor" placeholder="Enter Your Sponsor ID" value="{{ old('sponsor') }}">
											<span class="help-block" hidden>@lang('website.Please enter your sponsor ID')</span>
										</div>
									</div>
	                      		</div>
	                      		<div class="col-md-6">
						...
						<div class="row">
                  			<div class="col-md-6">
                  				<div class="from-group mb-3">
                  					<label for="inlineFormInputGroup"><strong  style="color: red;">*</strong>Country</label>
                  					<div class="input-group">
                  						<select class="form-control field-validate" name="country" id="inlineFormCustomSelect">
                  							<option selected value="india">India</option>
                  							<option value="dd" @if(!empty(old('country')) and old('gender')=='dd') selected @endif)>dd</option>
                  						</select>
                  						<span class="help-block" hidden>@lang('website.Please select your gender')</span>
                  					</div>
                  				</div>
                  			...
                  			<div class="col-md-6">
                  				<div class="from-group mb-3">
                  					<label for="inlineFormInputGroup"><strong  style="color: red;">*</strong>State</label>
                  					<div class="input-group">
                  						<select class="form-control field-validate" name="state " id="inlineFormCustomSelect">
                  							<option selected value="india">Odisha</option>
                  							<option value="dd" @if(!empty(old('country')) and old('gender')=='dd') selected @endif)>dd</option>
                  						</select>
                  						<span class="help-block" hidden>@lang('website.Please select your gender')</span>
                  					</div>
						...
						<div class="row">
							<div class="col-md-6">
                      			<div class="from-group mb-3">
                  					<label for="inlineFormInputGroup"><strong style="color: red;">*</strong>City</label>
                  					<div class="input-group">
                  						<input  name="city" type="text" class="form-control field-validate" id="city" value="{{ old('city') }}">
                      		...
                      		<div class="col-md-6">
                      			<div class="from-group mb-3">
                      				<label for="inlineFormInputGroup"><strong style="color: red;">*</strong>Nominee</label>
                      				<div class="input-group">
                      					<input name="nominee" id="nominee" type="nominee" class="form-control nominee"  placeholder="Please enter your nominee">
                      					<span class="help-block" hidden>Please enter your nominee</span>
						...
						<div class="row">
                  			<div class="col-md-6">
                  				<div class="from-group mb-3">
                  					<label for="inlineFormInputGroup"><strong style="color: red;">*</strong>Pan Number</label>
                  					<div class="input-group">
                  						<input  name="pan" type="text" class="form-control field-validate" id="pan" placeholder="Enter your PAN" value="{{ old('pan') }}">
                  						<span class="help-block" hidden>Please enter your PAN</span>
                  					</div>
                  				</div>
							</div>
                  			<div class="col-md-6">
                  				<div class="from-group mb-3">
                  					<label for="inlineFormInputGroup"><strong style="color: red;">*</strong>Adhar Number</label>
                  					<div class="input-group">
                  						<input  name="adhar" type="text" class="form-control field-validate" id="adhar" placeholder="Enter Your Adhar" value="{{ old('adhar') }}">
                  						<span class="help-block" hidden>Please enter your aadhar</span>
                  					</div>
                  				</div>
                  			</div>
						</div>
